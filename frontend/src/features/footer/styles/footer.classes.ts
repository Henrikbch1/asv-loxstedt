...
export const layoutClasses = {
  ...
  inner:
    'grid grid-cols-1 items-stretch gap-4 rounded-lg border border-white/10 bg-white/[0.06] p-4 shadow-[0_18px_40px_rgba(0,0,0,0.18)] md:grid-cols-2',
...
export const brandClasses = {
  ...
  mapWrap:
    'max-w-[600px] w-full overflow-hidden rounded-md min-h-[200px] h-full lg:h-full lg:max-w-none',
  mapIframe: 'w-full h-full border-0',
} as const;

export const contactClasses = {
  panel:
    'h-full rounded-md border border-white/10 bg-white/[0.05] p-5 break-words whitespace-normal text-left text-white/80',
